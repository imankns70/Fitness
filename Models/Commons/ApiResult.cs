...
using Fitness.Models.Enums;
using Microsoft.AspNetCore.Identity;
using Microsoft.AspNetCore.Mvc;
using Newtonsoft.Json;

namespace Fitness.Models.Commons
{
    ...
    public class ApiResult<TData> : ApiResult where TData : class
    {
        ...
        {
            List<string> Message = new List<string>() { "عدم دسترسی" };
            return new ApiResult<TData>(false, ApiResultStatusCode.UnAuthorized, null, Message);
        }
        ...
        {
            List<string> Message = new List<string>() { "محدودیت دسترسی" };
            return new ApiResult<TData>(false, ApiResultStatusCode.Forbiden, null, Message);
        }
        #endregion
